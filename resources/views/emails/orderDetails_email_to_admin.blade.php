      ...
      <div class="main-tble">
         <table style="width: 100%; max-width: 700px; margin: 0 auto; padding: 25px 10px; text-align: center; color: #3d464d; line-height: 10px;">
            <tbody>
               <tr>
                  <td align="center">
                     <h2 style="font-size: 35px;">Hello Admin</h2>
                     <h5 style="font-weight: 500; font-size: 18px;">One order has been received. Please review the order.</h5>
            ...
            <tbody>
               <tr>
                  ...
                  <td style="border-right: 1px dashed #e7e7e7; width: 25%; ">
                     ...
                     <p style="font-weight: 600; font-size: 1.1vw;">@php $date = new DateTime($order['order']['order_date']); @endphp
