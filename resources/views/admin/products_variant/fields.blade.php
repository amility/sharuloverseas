<div class="form-row">
    ...
    <div class="form-group col-sm-6">
        ...
        <input type="hidden" name="variationFlag" value="1">
    </div>
    ...
    <div class="form-group col-sm-6 d-none">
        ...
        {!! Form::text('prod_sku', 0, ['class' => 'form-control']) !!}
    </div>

    <div class="form-group col-sm-6 d-none">
        {!! Form::label('prod_price', 'Product Price:') !!}
        {!! Form::text('prod_price', 0, ['class' => 'form-control']) !!}
    </div>

    <div class="form-group col-sm-6 d-none">
        {!! Form::label('total_stock', 'Total Stock:') !!}
        {!! Form::text('total_stock', 0, ['class' => 'form-control']) !!}
    </div>
   <div class="form-group col-sm-6">
