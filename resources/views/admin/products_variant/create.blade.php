...
<ol class="breadcrumb">
   <li class="breadcrumb-item">
      <a href="#" onclick="gerenal();" class="variation_cls gern">Gerenal</a>
   </li>
   <li class="breadcrumb-item">
      <a href="#" onclick="variation();" class="variation_cls1 vari">Variations</a>
   </li>
</ol>
<!-- Nav tabs -->
<div class="gerenal">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-12 mt-3">
                                   <div class="row">
                                       <div class="col-md-3">
                                          <label for="">
                                             <input type="checkbox" name="choose_img1" value="1"> Front Images
                                          </label>
                                          <input name="select_file" type="file" multiple />
                                       </div>
                                       <div class="col-md-3">
                                          <label for="">
                                          <input type="checkbox" name="choose_img2" value="2">
                                          Left Images
                                          </label>
                                          <input name="select_file1" type="file" multiple />
                                       </div>
                                       <div class="col-md-3">
                                          <label for="">
                                          <input type="checkbox" name="choose_img3" value="3">
                                          Right Images
                                          </label>
                                          <input name="select_file2" type="file" multiple />
                                       </div>
                                       <div class="col-md-3">
                                          <label for="">
                                          <input type="checkbox" name="choose_img4" value="4">
                                          Back Images
                                          </label>
                                          <input name="select_file3" type="file" multiple />
                                       </div>
                                   </div>
                                  </div>
                                </div>
...
<script>
       $("form[name='demoform']").submit(function(event) {
         ...
         $('#upload_form').on('submit', function(event){
            event.preventDefault();
            $.ajax({
               url:"{{route('products.variantStore')}}",
               method:"POST",
               ...
               success:function(data)
               {
                  ...
                  // inserting product_id into hidden input field
                     $("#product_idss").val(data.product_id); 
                     $('.success_messsage1').html(data.message1);
                  }
               }
            })
         });
           ...
           function gerenal(){
             $('.variation').hide();
             $('.gerenal').show(); 
             $('.gern').addClass('variation_cls');
             $('.vari').css({"background":"white","color":"black"});
           }
   
           function variation(){
             $('.variation').show();
             $('.gerenal').hide();
             $('.gern').removeClass('variation_cls');
             $('.vari').css({"background":"black","color":"white"});
           }
