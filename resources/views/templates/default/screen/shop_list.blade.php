              ...
              <div class="widget-products__list">
                <div class="widget-products__item">
                  ...
                  <div class="widget-products__info">
                    ...
                    <div class="widget-products__prices">{{CurrencySymbol()}} 749.00</div>
                  </div>
                </div>
                <div class="widget-products__item">
                  <div class="widget-products__image">
                  ...
                  <div class="widget-products__info">
                    ...
                    <div class="widget-products__prices">{{CurrencySymbol()}} 1,019.00</div>
                  </div>
                </div>
                <div class="widget-products__item">
                  <div class="widget-products__image">
                  ...
                  <div class="widget-products__info">
                    ...
                    <div class="widget-products__prices">{{CurrencySymbol()}} 850.00</div>
                  </div>
                </div>
                <div class="widget-products__item">
                  <div class="widget-products__image">
                  ...
                  <div class="widget-products__info">
                    ...
                    <div class="widget-products__prices"><span class="widget-products__new-price">{{CurrencySymbol()}} 949.00</span> <span class="widget-products__old-price">{{CurrencySymbol()}} 1189.00</span></div>
                  </div>
                </div>
                <div class="widget-products__item">
                  <div class="widget-products__image">
                  ...
                  <div class="widget-products__info">
                    ...
                    <div class="widget-products__prices">{{CurrencySymbol()}} 1,700.00</div>
                  </div>
                </div>
              </div>
            </div>
