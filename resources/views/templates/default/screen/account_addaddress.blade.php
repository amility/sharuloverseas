        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-8 mt-lg-0">
                <div class="card">
                    ...
                    <form method="POST" action="{{ url('/customer/account-createaddress') }}@if(request()->has('redirect') == 'checkout')?redirect=checkout @endif">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="col-12 col-lg-10 col-xl-8">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" name="email_address" class="form-control @error('email_address') is-invalid @enderror" id="checkout-email" placeholder="Email address" value="{{old('email_address')}}">
                                        @error('email_address')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" id="checkout-phone" placeholder="Phone" value="{{old('phone')}}">
                                        @error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="first_name" class="form-control @error('first_name') is-invalid @enderror" id="checkout-first-name" placeholder="First Name" value="{{old('first_name')}}">
                                        @error('first_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="last_name" class="form-control @error('last_name') is-invalid @enderror" id="checkout-last-name" placeholder="Last Name" value="{{old('last_name')}}">
                                        @error('last_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_name" class="form-control @error('company_name') is-invalid @enderror" id="checkout-company-name" placeholder="Company Name" value="{{old('company_name')}}">
                                    @error('company_name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="block" class="form-control @error('block') is-invalid @enderror" id="checkout-street-address" placeholder="Block" value="{{old('block')}}">
                                    @error('block')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="street_address" class="form-control @error('street_address') is-invalid @enderror" id="checkout-street-address" placeholder="Street Address" value="{{old('street_address')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="house_building" class="form-control @error('house_building') is-invalid @enderror" id="checkout-street-address" placeholder="House & Building" value="{{old('house_building')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="appartment" class="form-control @error('appartment') is-invalid @enderror" id="checkout-address" value="{{old('appartment')}}">
                                    @error('appartment')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    <label for="checkout-street-address">Additional direction</label>
                                    <textarea class="form-control " id="checkout-extra-direction" name="extra_direction" value="{{old('extra_direction')}}" rows="3"> </textarea>
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <input type="text" name="postcode_zip" class="form-control @error('postcode_zip') is-invalid @enderror" id="checkout-postcode" value="{{old('postcode_zip')}}">
                                    @error('postcode_zip')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
